    ...
    <div id="Project" className="project">
      ...
      <div id="project1" style={{ marginBottom: "20px" }}>
        <div id="specp1" className="slideshow">
          <div
            ...
            style={{ transform: `translate3d(${-uberIndex * 100}%, 0, 0)` }}
          >
            {uber.map((el, index) => (
          ...
          <div id="comp">
            <button
              onClick={() =>
                window.open(
                  "https://github.com/anoxco0/ubereats-clone",
                  "_blank"
                )
              }
            >
            ...
            <button
              onClick={() =>
                window.open("http://ubereats-clone.herokuapp.com/", "_blank")
              }
            >
              Site
            </button>
            <button
              onClick={() =>
                window.open(
                  "https://drive.google.com/file/d/1lVeW-frYUli1Jf25ErfxQ399oZmm_EON/view?usp=sharing",
                  "_blank"
                )
              }
            >
            ...
            <button
              onClick={() =>
                window.open(
                  "https://medium.com/@navneetharsh3/uber-eats-clone-b8894f480dbb",
                  "_blank"
                )
              }
            >
        ...
        <div id="specp2">
          <h1>Clone of Uber Eats</h1>
          <p>
            Uber Eats is an online food ordering and delivery platform. Users
            can read menus, reviews and ratings, order, and pay for food{" "}
          </p>
          <p>This is a collaborative project.</p>
          <p>
            My area of responsibility in this project is to build the Home page,
            Login and Signup Page, reusable Navbar, and the API.
          </p>
          <div id="stack">
      ...
      <div id="project1">
        <div id="specp1" className="slideshow">
          ...
          <div id="comp">
            <button
              onClick={() =>
                window.open(
                  "https://github.com/https://github.com/anoxco0/specmaker-front.git/specmakers.git",
                  "_blank"
                )
              }
            >
            ...
            <button
              onClick={() =>
                window.open("http://specmaker-front.vercel.app/", "_blank")
              }
            >
              Site
            </button>
            <button
              onClick={() =>
                window.open(
                  "https://www.linkedin.com/posts/navneet-kumar-77186721b_project-masaischool-coding-ugcPost-6900148288457105408-o6OV?utm_source=linkedin_share&utm_medium=member_desktop_web",
                  "_blank"
                )
              }
            >
        ...
        <div id="specp2">
          ...
          <p>
            Specmaker is an e-commerce web application of eyeglasses and contact
            lenses
          </p>
          <p>This is a collaborative project.</p>
          <p>
            My area of responsibility in this project is to build the Home page,
            Product pages, reusable Navbar, and the API.
          </p>
          <div id="stack">
            <div id="builtwith">Built With:</div>
            <div id="stacks">
      ...
      <div id="project1">
        <div id="specp1" className="slideshow">
          <div
            className="slideshowSlider"
            style={{ transform: `translate3d(${-nykaaIndex * 100}%, 0, 0)` }}
          >
            {nykaa.map((el, index) => (
              <img className="slide" id="Spec1" src={el} alt="" />
            ))}
          ...
          <div id="comp">
            <button
              onClick={() =>
                window.open(
                  "https://github.com/anoxco0/nykaa-fashion.git",
                  "_blank"
                )
              }
            >
            ...
            <button
              onClick={() =>
                window.open("http://nykaa-fashion-five.vercel.app", "_blank")
              }
            >
              Site
            </button>
            <button
              onClick={() =>
                window.open(
                  "https://drive.google.com/file/d/1NqoT8v86ixR13mkRXF8-14D78h71M1EW/view?usp=sharing",
                  "_blank"
                )
              }
            >
            ...
            <button
              onClick={() =>
                window.open(
                  "https://medium.com/@navneetharsh3/nykaa-fashion-clone-82266d65a3f2",
                  "_blank"
                )
              }
            >
        ...
        <div id="specp2">
          ...
          <p>
            Nykaa Fashion is an e-commerce web application of beuty, wellness
            and fashion products.
          </p>
          <p>This is a collaborative project.</p>
          <p>
            My area of responsibility in the project was to build the Home page,
            Product pages, login, signup, wishlist, and reusable Navbar.
          </p>
          <div id="stack">
            <div id="builtwith">Built With:</div>
            <div id="stacks">
        ...
        <div id="specp1" className="slideshow">
          ...
          <div id="comp">
            <button
              onClick={() =>
                window.open(
                  "https://github.com/anoxco0/weather_app.git",
                  "_blank"
                )
              }
            >
            ...
            <button
              onClick={() =>
                window.open("https://weather-app-anoxco0.vercel.app/", "_blank")
              }
            >
              Site
            </button>
