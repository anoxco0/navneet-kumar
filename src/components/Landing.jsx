    ...
    return (
        ...
        <div id='Project' className='project'>
                ...
                <div id='comp'>
                    ...
                    <button onClick={()=>window.open("https://drive.google.com/file/d/1lVeW-frYUli1Jf25ErfxQ399oZmm_EON/view?usp=sharing","_blank")}>Demo</button>
                    <button onClick={()=>window.open("https://medium.com/@navneetharsh3/uber-eats-clone-b8894f480dbb","_blank")}>Blog</button>
                </div>
                </div>
                <div id='specp2'>
                    <h1>Clone of Uber Eats</h1>
                    <p>Uber Eats is an online food ordering and delivery platform. Users can read menus, reviews and ratings, order, and pay for food </p>
                    <p>This is a collaborative project.</p>
                    <p>My area of responsibility in this project is to build the Home page, Login and Signup Page, reusable Navbar, and the API.
                    </p>
                    <div id='stack'>
            ...
            <div id='project1'>
                ...
                <div id='comp'>
                        <button onClick={()=>window.open('https://github.com/https://github.com/anoxco0/specmaker-front.git/specmakers.git',"_blank")}>Code</button>
                    <button onClick={()=>window.open("http://specmaker-front.vercel.app/","_blank")}>Site</button>
